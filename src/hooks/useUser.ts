...
export function useUserProfile() {
  return useGet(queryKeys.auth.profile(), () => UserService.getProfile(), {
...
export function useUpdateProfile() {
  ...
  return useUpdate((userData: UpdateUserRequest) => UserService.updateProfile(userData), {
    successMessage: "Cập nhật thông tin thành công!",
    invalidateQueries: [queryKeys.auth.profile(), queryKeys.auth.me()],
    onSuccess: () => {
...
export function useUsers(filters?: {
  ...
  return useGetPaginated(queryKeys.users.list(filters || {}), () => UserService.getUsers(filters), {
    enabled: !!filters,
  });
}

export function useUser(id: number) {
  return useGet(queryKeys.users.detail(id), () => UserService.getUserById(id), {
    enabled: !!id,
  });
}
...
export function useDeleteUser() {
  ...
  return useDelete((id: number) => UserService.deleteUser(id), {
...
export function useUploadAvatar() {
  ...
  return useCreate((file: File) => UserService.uploadAvatar(file), {
