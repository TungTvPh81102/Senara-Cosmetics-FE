...
import { apps } from "@/components/layouts/data/apps";
...
export function Page() {
  ...
  // Sync state với URL params khi component mount
  useEffect(() => {
    setSort(initSort);
    setAppType(type);
    setSearchTerm(filter);
  }, [initSort, type, filter]);
  ...
  const handleSearch = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setSearchTerm(value);
    updateURL({ filter: value || undefined });
  };
